...
When I'm not working, I'm likely walking among trees or [reading a book]({{ '/books/' | relative_url }}). 

I served four years as a [search and rescue volunteer]({{ '/tags/#search%20and%20rescue' | relative_url }}) and currently volunteer with [{% include tko_icon.html %} Trailkeepers of Oregon](https://trailkeepersoforegon.org/) and [{% include rubicon_icon.html %}  Team Rubicon](https://teamrubiconusa.org/).
