...
I’m just 58 pages into <i>Parable of the Talents</i> as I write this, so it's ranking here is largely on the strength of the first volume. And while it’s perhaps cheating to combine two books into a single number one, we live in unconventional times.  
